...
def update_tool_template(file_path):
    ...
    try:
        ...
        # Update extends
        content = content.replace('{% extends "base.html" %}', '{% extends "tools/tools_base.html" %}')
...
def main():
    ...
    tool_templates = [t for t in tool_templates if not any(ex in t for ex in exclude_files)]
