...
# Professional Infrastructure Tools - All require authentication
all_tools = [
    # -------- AI-Powered Professional Tools --------
    {
        "name": "AI Content Optimizer Pro",
        "endpoint": "ai_content_optimizer.ai_content_optimizer",
        "description": "Professional AI-powered content optimization using advanced machine learning models. Pro subscription required.",
    ...
    # -------- Professional Meta Tags Tools --------
    {
        "name": "Advanced Meta Tag Analyzer",
        "endpoint": "meta_tag_analyzer.meta_tag_analyzer",
        "description": "Professional meta tag analysis with AI-powered scoring and optimization suggestions.",
        "category": "Professional SEO Tools",
        "requires_login": True,
    },
    {
...
def category_page(category_slug):
    ...
    return render_template(
        "tools/category_page.html", tools=filtered, category=display_name
    )
