...
from app.blueprints.admin.forms import AdminSettingForm  # Updated import path
from app.models.order import Order  # Updated import path
from app.models.order import Download  # Updated import path
from app.models.setting import Setting  # Updated import path
...
def _render_overview():
    try:
        ...
        return (
            render_template(
                "admin/sections/error.html", error="Failed to load overview"
            ),
            500,
        )
...
def _render_orders():
    try:
        ...
        return render_template(
            "admin/sections/orders.html", orders=orders, user=current_user
        )
    except Exception as e:
        logger.error(f"Failed to render orders: {e}", exc_info=True)
        return (
            render_template("admin/sections/error.html", error="Failed to load orders"),
            500,
        )
...
def _render_downloads():
    try:
        ...
        return render_template(
            "admin/sections/downloads.html", downloads=downloads, user=current_user
        )
    except Exception as e:
        logger.error(f"Failed to render downloads: {e}", exc_info=True)
        return (
            render_template(
                "admin/sections/error.html", error="Failed to load downloads"
            ),
            500,
        )
...
def _render_settings():
    try:
        ...
        return (
            render_template(
                "admin/sections/error.html", error="Failed to load settings"
            ),
            500,
        )
...
def section(name):
    ...
    try:
        ...
        return (
            render_template("admin/sections/error.html", section=name, error=str(e)),
            500,
        )
