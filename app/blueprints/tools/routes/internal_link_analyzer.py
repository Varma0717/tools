...
from app.blueprints.tools.utils.internal_link_analyzer_utils import extract_internal_links
...
@internal_link_analyzer_bp.route("/internal-link-analyzer/")
def internal_link_analyzer_page():
    """Internal Link Analyzer main page."""
    return render_template("tools/internal_link_analyzer.html", csrf_token=generate_csrf())
