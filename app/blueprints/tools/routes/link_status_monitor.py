...
from app.blueprints.tools.utils.link_status_monitor_utils import check_link_status
...
@link_status_monitor_bp.route("/link-status-monitor/")
def link_status_monitor_page():
    """Link Status Monitor main page."""
    return render_template("tools/link_status_monitor.html", csrf_token=generate_csrf())
