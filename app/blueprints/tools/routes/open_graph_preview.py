...
@open_graph_preview_bp.route("/open-graph-preview/")
def open_graph_preview_page():
    """Open Graph Preview main page."""
    return render_template("tools/open_graph_preview.html", csrf_token=generate_csrf())
