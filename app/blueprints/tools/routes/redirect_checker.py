...
def redirect_checker():
    ...
    return render_template("tools/redirect_checker.html", csrf_token=generate_csrf(), form=form, chain=chain)

\nfrom flask import jsonify\nfrom app.utils.auth_decorators import freemium_tool\n\nredirect_checker_bp = Blueprint("redirect_checker", __name__, url_prefix="/tools")\n

@redirect_checker_bp.route("/redirect-checker/")
def redirect_checker_page():
    """Redirect Checker main page."""
    return render_template("tools/redirect_checker.html", csrf_token=generate_csrf())
