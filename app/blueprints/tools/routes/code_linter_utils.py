...
code_linter_utils_bp = Blueprint("code_linter_utils", __name__, url_prefix="/tools")
\nimport subprocess
import tinycss2
...
@code_linter_utils_bp.route("/code-linter-utils/")
def code_linter_utils_page():
    """Code Linter Utils main page."""
    return render_template("tools/code_linter_utils.html", csrf_token=generate_csrf())
